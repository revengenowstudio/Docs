...
- **复仇时刻正式版0.99.902** （最新版）：
  ...
  - 阿里云地址：https://www.aliyundrive.com/s/AKEWumnAiiN
  - 即装即玩，独立安装包，禁止安装在其它游戏程序中。
  - （已支持自动更新。如果启动器无法自动更新请[点击此处](./Launcher-Unable-to-update.md)）


 - **复仇时刻正式版0.99.902更新程序**，**需要0.98.728及以上**版本 
   
    -  百度云下载地址： https://pan.baidu.com/s/1ALYJjTQap8zNEaUUzkd2hw  提取码:5a21
    -  适用于旧版复仇时刻作为更新使用

  
- **目前群测最新版本**（需自动更新）为：**0.99.905**

- **目前正式版最新版本**（需自动更新）为：**0.99.905**  

!> 打开复仇时刻启动器（Launcher.exe）即可进行自动更新
